...
function draw() {
  ...
  rect(0, 980, width, 100);
   imageMode(CORNER);
   image(img,-38, -325, width, img.height*width/img.width);
  if (frameCount % 10 == 0) {
  ...
  textAlign(LEFT);
    text(p1[index], width*0.05, height-55);
    if (int(val)% 510 ==0){
      index ++;
    }
    if(index==10){
     ...
     textAlign(CENTER);
     text(p2[index], width*0.3, height-55);
    if (int(val)% 510 ==0){
      index ++;
    }
    if(index==9){
    ...
    if(index==8){
     ...
     textAlign(RIGHT);
     text(p4[index], width*0.95, height-55);
    if (int(val)% 510 ==0){
      index ++;
    }
    if(index==7){
